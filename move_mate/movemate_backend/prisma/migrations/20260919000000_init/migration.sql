...
ALTER TABLE shuttles DROP CONSTRAINT IF EXISTS shuttles_status_check;
ALTER TABLE shuttles ADD CONSTRAINT shuttles_status_check CHECK (status IN ('active', 'inactive', 'maintenance'));
ALTER TABLE trips DROP CONSTRAINT IF EXISTS trips_status_check;
ALTER TABLE trips ADD CONSTRAINT trips_status_check CHECK (status IN ('active', 'completed', 'cancelled'));