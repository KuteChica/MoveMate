...
function Navbar() {
	...
	return (
		<header className="relative z-50 border-b border-[#e1eceb] bg-white">
			<div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 sm:px-10 lg:px-12">
				...
				<nav aria-label="Primary navigation" className={`${isOpen ? "flex" : "hidden"} absolute left-0 right-0 top-[57px] z-50 flex-col border-b border-[#e1eceb] bg-white px-6 py-4 shadow-lg md:static md:flex md:flex-row md:items-center md:gap-7 md:border-0 md:p-0 md:shadow-none`}>
