...
function Dashboard() {
  ...
  return (
    <section className="mx-auto w-full max-w-6xl px-6 py-10">
      ...
      <h1 className="mt-2 text-4xl font-semibold tracking-tight text-slate-900">Good morning, {user?.name ?? "Student rider"}</h1>
      <p className="mt-3 text-slate-600">Your next ride is ready when you are.</p>
      <div className="mt-8 grid gap-4 md:grid-cols-3">
        <div className="rounded-lg border border-teal-100 bg-teal-50 p-5 md:col-span-2"><p className="text-sm font-semibold text-teal-800">Nearest shuttle</p><h2 className="mt-2 text-2xl font-semibold text-slate-900">Shuttle A</h2><p className="mt-1 text-slate-600">Current location: Main Gate</p><p className="mt-5 text-sm text-slate-600">Next stop <span className="font-semibold text-slate-900">Administration Block</span></p><p className="mt-1 text-3xl font-semibold text-teal-800">5 min <span className="text-sm font-normal text-slate-600">estimated arrival</span></p></div>
